...
import com.syc.cloud.core.exception.FeignServiceException;
...
public class FeignConfig implements RequestInterceptor {
    ...
    public void apply(RequestTemplate requestTemplate) {
        ...
        if (attributes != null) {
            ...
            requestTemplate.header(Const.PROXY_HOST, request.getHeader(Const.PROXY_HOST));
        }
    }
    ...
    public static class FeignDecode extends SpringDecoder {
        ...
        public FeignDecode(ObjectFactory<HttpMessageConverters> messageConverters) {
